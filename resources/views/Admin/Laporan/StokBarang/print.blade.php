...
<head>
    ...
    <!-- FAVICON -->
    @if($web->web_logo == '' || $web->web_logo == 'taripar.png')
    <link rel="shortcut icon" type="image/x-icon" href="{{url('/assets/default/web/taripar.png')}}" />
    @else
...
<body onload="window.print()">
    ...
    <center>
        @if($web->web_logo == '' || $web->web_logo == 'taripar.png')
        <img src="{{url('/assets/default/web/taripar.png')}}" width="80px" alt="">
        @else
        <img src="{{url('/assets/default/web/taripar.png')}}" width="80px" alt="">
        @endif
    </center>
    ...
    <table border="1" id="table1">
        ...
        <tbody>
            ...
            <?php 
            if($tglawal == ''){
                $jmlmasuk = BarangmasukModel::leftJoin('tbl_barang', 'tbl_barang.barang_kode', '=', 'tbl_barangmasuk.barang_kode')->leftJoin('tbl_pengecek', 'tbl_pengecek.pengecek_id', '=', 'tbl_barangmasuk.pengecek_id')->where('tbl_barangmasuk.barang_kode', '=', $d->barang_kode)->sum('tbl_barangmasuk.bm_jumlah');
            }else{
                $jmlmasuk = BarangmasukModel::leftJoin('tbl_barang', 'tbl_barang.barang_kode', '=', 'tbl_barangmasuk.barang_kode')->leftJoin('tbl_pengecek', 'tbl_pengecek.pengecek_id', '=', 'tbl_barangmasuk.pengecek_id')->where('tbl_barangmasuk.barang_kode', '=', $d->barang_kode)->whereBetween('bm_tanggal', [$tglawal, $tglakhir])->sum('tbl_barangmasuk.bm_jumlah');
            }
