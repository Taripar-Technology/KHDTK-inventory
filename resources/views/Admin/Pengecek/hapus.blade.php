    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-body text-center p-4 pb-5">
                ...
                <h3 class="mb-5">Yakin hapus <span id="vpengecek"></span> ?</h3>
                <input type="hidden" name="idpengecek" id="idpengecek">
...
<script>
    function submitFormH() {
        setLoadingH(true);
        const id = $("input[name='idpengecek']").val();

        $.ajax({
            type: 'POST',
            url: "{{url('admin/pengecek/proses_hapus')}}/" + id,
